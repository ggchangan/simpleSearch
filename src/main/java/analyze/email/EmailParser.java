...
public class EmailParser {
    ...
    public Email parse(File inputFile) throws MessagingException, IOException {
        BufferedInputStream bis = gb2312ToGb18030(inputFile);
    ...
    private BufferedInputStream gb2312ToGb18030(File f) throws IOException {
        final String gb2312Regex = "=\\?gb2312\\?";
        final String gb18030Encoding = "=?gb18030?";
        Charset charset = StandardCharsets.UTF_8;
        String fContent= new String(Files.readAllBytes(f.toPath()), charset);
        fContent = fContent.replaceAll(gb2312Regex, gb18030Encoding);
        return new BufferedInputStream(new ByteArrayInputStream(fContent.getBytes()));
    }
    ...
    private Email doParse(MimeMessage msg) throws MessagingException, IOException {
        ...
        email.messageId = msg.getMessageID();
        ...
        email.receiveds = msg.getHeader("Received");
        
        email.xOriginatingIp = getXOriginatingIp (msg);
        ...
        Enumeration<String> hdrEnum = msg.getAllHeaderLines();
    ...
    private String getXOriginatingIp(MimeMessage msg) throws MessagingException {
        String[] xoi = msg.getHeader("x-originating-ip");
        if (xoi != null && xoi.length != 0){
            return xoi[0];
        }
        return null;
    }
